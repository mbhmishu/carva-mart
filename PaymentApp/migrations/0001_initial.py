# Generated by Django 4.1.4 on 2023-12-28 18:19
    ...
    operations = [
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('Attach_image', models.ImageField(blank=True, null=True, upload_to='order')),
                ('provid_any_link', models.URLField(blank=True, null=True)),
                ('is_creat', models.BooleanField(default=False)),
                ('item', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, to='ShopingApp.product')),
